<template>
  <v-app id="app">
    ...
    <v-app-bar :clipped-left="$vuetify.breakpoint.lgAndUp" color="blue darken-2" app dark>
      ...
      <v-toolbar-title class="app-title">@jood/v-colrow</v-toolbar-title>
      <v-spacer></v-spacer>
...
export default defineComponent({
  setup() {
    ...
    const onGoDocument = () => {
      openTo('https://molgga.github.io/jood-v-colrow/documents');
    };

    const onGoGithub = () => {
      openTo('https://github.com/molgga/jood-v-colrow');
    };

    const onGoNpm = () => {
      openTo('https://www.npmjs.com/package/@jood/v-colrow');
    };
